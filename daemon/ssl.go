...
func sslKeyPem() (*asset, error) {
	bytes, err := sslKeyPemBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "ssl/key.pem", size: 1675, mode: os.FileMode(384), modTime: time.Unix(1461537458, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
var _bindata = map[string]func() (*asset, error){
	"ssl/cert.pem": sslCertPem,
	"ssl/key.pem": sslKeyPem,
}
...
var _bintree = &bintree{nil, map[string]*bintree{
	"ssl": &bintree{nil, map[string]*bintree{
		"cert.pem": &bintree{sslCertPem, map[string]*bintree{}},
		"key.pem": &bintree{sslKeyPem, map[string]*bintree{}},
	}},
}}
